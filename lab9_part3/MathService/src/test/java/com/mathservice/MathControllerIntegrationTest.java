...
@AutoConfigureStubRunner(
        ...
        ids = "evenodd:EvenOddApplication:+:stubs:8090")
public class MathControllerIntegrationTest {
    ...
    @Test
    public void given_WhenPassNumberInQueryParam_ThenReturnItsDouble()
            throws Exception {

        mockMvc.perform(MockMvcRequestBuilders.get("/double?number=4")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    @Test
    public void given_WhenPassTwoNumbersInQueryParam_ThenReturnTheirSum()
            throws Exception {
